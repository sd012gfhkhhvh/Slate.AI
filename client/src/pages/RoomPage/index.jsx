  ...
  return (
    ...
    <div className="mainCanvas d-flex flex-wrap">
      ...
      <div className="d-flex flex-column justify-content-between align-items-center">
        ...
        <div className="d-flex border rounded-3 flex-col gap-2 py-3 px-2">
      ...
      <div className="canvas-box col-md-9 mr-16 border-2 border-black border-solid rounded-md mx-auto mt-4">
        <WhiteBoard
          canvasRef={canvasRef}
          ctxRef={ctxRef}
          elements={elements}
      ...
      <div className="d-flex flex-column justify-content-between">
        ...
        <div className="absolute right-0 top-0 m-2">
          <button
            ...
            className="bg-white border-2 border-red-900 border-solid text-red-900 p-2 rounded-md transition-all"
          >
            Clear canvas
          </button>
        </div>
        <div className="flex justify-center items-center gap-2 absolute bottom-0 right-0">
          <button
